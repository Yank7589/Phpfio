...
$API_KEY = "6903068807:AAHCxyONmNV11ddq6NrEoZ2S7oGFVJ0oJxI"; //التوكن.
$AymnAldorafy = 6899667428; //الأدمن.
...
$exAymn = explode("-",$data);
 ...
 [['text'=>"🧑🏻‍💼︙مطور البوت.",'url'=>"tg://user?id=6899667428"]],
 ];
 #======={الازرار الثانوية}=======#
 $EngAymnBack = [
...
if($text == "/start"){
	...
	aldorafy();
		...
		'photo'=>"https://telegra.ph/file/042678e4fe946742b947f.jpg",
		'caption'=>"
